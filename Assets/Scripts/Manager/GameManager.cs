...
public class GameManager : MonoBehaviour
{
    ...
    public void LoadNextLevel()
    {
        ...
        {
            _currentLevelIndex++;
            comboMultiplier++;  // Tăng combo multiplier khi người chơi vượt qua level
            LoadLevel(_currentLevelIndex);
        }
        else
        {
            // Lưu lại combo multiplier lớn nhất khi đạt đến bàn chơi cuối cùng
            PlayerPrefs.SetInt("HighestComboMultiplier", comboMultiplier);
    ...
    public void LoadPreviousLevel()
    {
        ...
        if (_currentLevelIndex > 0 && !testGame)
        {
            ...
            comboMultiplier = 1;  // Reset combo multiplier khi quay lại level trước
    ...
    public void LoadGameData()
    {
        ...
        {
            comboMultiplier = PlayerPrefs.GetInt("ComboMultiplier");
        }
